        ...
        <div className="min-h-[70vh] flex items-center px-4 md:px-6">
          <div className="max-w-[1200px] w-full mx-auto">
            <div className="py-8 md:py-10 flex flex-col items-center text-center">
              ...
              <h1 className="text-[34px] md:text-[40px] font-bold tracking-tight text-slate-900 md:whitespace-nowrap">{t('pending.title')}</h1>
              <p className="mt-2.5 max-w-[1050px] text-lg md:text-2xl leading-8 md:leading-[1.35] text-slate-600">{t('pending.description')}</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="min-h-[70vh] flex items-center px-4 md:px-6">
          <div className="max-w-[1200px] w-full mx-auto">
            <div className="py-8 md:py-10 flex flex-col items-center text-center">
              ...
              <h1 className="text-[34px] md:text-[40px] font-bold tracking-tight text-slate-900 md:whitespace-nowrap">{t('approved.title')}</h1>
              <p className="mt-2.5 max-w-[1050px] text-lg md:text-2xl leading-8 md:leading-[1.35] text-slate-600">{t('approved.description')}</p>
              <div className="mt-6 flex flex-col items-center gap-2.5 sm:flex-row sm:justify-center sm:flex-wrap">
                <Button
                  size="lg"
        ...
        <div className="min-h-[70vh] flex items-center px-4 md:px-6">
          <div className="max-w-[1200px] w-full mx-auto">
            <div className="py-8 md:py-10 flex flex-col items-center text-center">
              ...
              <h1 className="text-[34px] md:text-[40px] font-bold tracking-tight text-slate-900 md:whitespace-nowrap">{t('rejected.title')}</h1>
              <p className="mt-2.5 max-w-[1050px] text-lg md:text-2xl leading-8 md:leading-[1.35] text-slate-600">{t('rejected.description')}</p>
              <div className="mt-6">
                <Button
                  size="lg"
                  className="h-10 rounded-xl bg-indigo-600 px-6 text-sm text-white hover:bg-indigo-700"
