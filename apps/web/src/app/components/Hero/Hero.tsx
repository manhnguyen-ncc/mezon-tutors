      ...
      >
        ...
        >
          <YStack width="$homeHeroFlashIcon" height="$homeHeroFlashIcon">
            <img src="/icons/flash.svg" alt="flash" width={16} height={16} />
          </YStack>
          ...
          >
            <XStack gap="$2" alignItems="center">
              <YStack width={20} height={20}>
                <img className="home-demo-icon" src="/icons/wdemo.svg" alt="demo" width={20} height={20} />
              </YStack>
      ...
      >
        <YStack position="relative">
          ...
          >
            ...
            <YStack position="absolute" bottom={0} left={0} padding="$5" width="100%" style={{ zIndex: 2 }}>
              <XStack gap="$2.5" marginBottom="$2" alignItems="center">
                ...
                >
                  <img src="/icons/star.svg" alt="star" width={14} height={14} />
          ...
          {!isCompact && (
            ...
            >
              <img src={HOME_HERO_CARD.videoThumbnail} alt="video" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
              ...
              >
                <img src="/icons/play.svg" alt="play" style={{ width: '62%', height: '62%', objectFit: 'contain' }} />
              </YStack>
            </YStack>
          )}
        </YStack>
